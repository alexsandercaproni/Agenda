...
public class DetalhesProvaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView materia = (TextView) findViewById(R.id.detalhes_materia);
        TextView data = (TextView) findViewById(R.id.detalhes_data);
        ListView listaTopicos = (ListView) findViewById(R.id.detalhes_list);
